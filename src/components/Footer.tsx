...
const Footer = () => {
    return (
        <div className="py-24 px-4 md:px-8 lg:px-12 xl:px-28 2xl:px-60 bg-gray-100 text-sm mt-24">
            {/* TOP */}
            <div className="flex flex-col md:flex-row justify-between gap-24">
                ...
                <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
                    ...
                    <p>be the first to get the latestt news about trends, promotions and much more!</p>
                    <div className="flex">
